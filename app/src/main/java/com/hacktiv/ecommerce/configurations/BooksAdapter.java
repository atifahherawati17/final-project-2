...
import com.hacktiv.ecommerce.activities.books_produt.detail_product.Book1Activity;
import com.hacktiv.ecommerce.activities.books_produt.detail_product.Book2Activity;
import com.hacktiv.ecommerce.activities.books_produt.detail_product.Book3Activity;
...
public class
BooksAdapter extends RecyclerView.Adapter<BooksAdapter.ViewHolder> {

    List<String> title, image;
    Context context;


    public BooksAdapter(Context context, List<String> title, List<String> image) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                switch (currentPosition){
                    case 0:
                        intent = new Intent(view.getContext(), Book1Activity.class);
                        context.startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(view.getContext(), Book2Activity.class);
                        context.startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(view.getContext(), Book3Activity.class);
                        context.startActivity(intent);
                        break;
                }
