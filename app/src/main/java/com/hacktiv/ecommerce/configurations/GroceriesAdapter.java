...
import com.hacktiv.ecommerce.activities.groceries_product.detail_product.Groceries1Activity;
import com.hacktiv.ecommerce.activities.groceries_product.detail_product.Groceries2Activity;
import com.hacktiv.ecommerce.activities.groceries_product.detail_product.Groceries3Activity;
...
public class
GroceriesAdapter extends RecyclerView.Adapter<GroceriesAdapter.ViewHolder> {

    List<String> title, image;
    Context context;


    public GroceriesAdapter(Context context, List<String> title, List<String> image) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                switch (currentPosition){
                    case 0:
                        intent = new Intent(view.getContext(), Groceries1Activity.class);
                        context.startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(view.getContext(), Groceries2Activity.class);
                        context.startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(view.getContext(), Groceries3Activity.class);
                        context.startActivity(intent);
                        break;
                }
